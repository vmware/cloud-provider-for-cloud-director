...
| 1.1.2 | 36.0+ | 10.3.1+ <br/>(10.3.1 needs hot-patch to prevent VCD cell crashes in multi-cell environments) | <ul><li>Fixes system administrator use case where external IP addresses for a LB service are picked from edge gateway of a different tenant than intended.</li></ul> |<ul><li>1.21</li><li>1.20</li><li>1.19</li></ul>|
