...
| :---------: | :---------: | :-----------------------: | :--------------------------------: | :---: | :------------------ | :--: |
| 1.3.0 | 4.0.0 | 36.0+ | 10.3.1+ <br/>(10.3.1 needs hot-patch to prevent VCD cell crashes in multi-cell environments) | <ul><li>Support for user specified load balancer IP. However updating the user specified load balancer IP is not supported when CPI is configured with `enableVirtualServiceSharedIP: true` and `oneArm: nil`</li><li>Support for SSL termination at ingress with `appProtocol: https`</li></ul> |<ul><li>1.22</li><li>1.21</li><li>1.20</li><li>1.19</li></ul>|[CPI 1.3.z docs](https://github.com/vmware/cloud-provider-for-cloud-director/tree/1.3.z)|
