...
| :---------: | :---------: | :-----------------------: | :--------------------------------: | :---: | :------------------ | :--: |
| 1.4.0 | 4.0.0+ | 36.0 | 10.3.1+ <br/>(10.3.1 needs hot-patch to prevent VCD cell crashes in multi-cell environments) | <ul><li>Support for packaging CPI CRS in a container for CSE airgap workflow.</li><li>Setting computer name as vm name in case naming policies require this.</li><li>Bug fixes: safe access for OVDC and safe access for OVDC network</li></ul> |<ul><li>1.23</li><li>1.22</li><li>1.21</li><li>1.20</li></ul>|[CPI 1.4.z docs](https://github.com/vmware/cloud-provider-for-cloud-director/tree/1.4.z)|
