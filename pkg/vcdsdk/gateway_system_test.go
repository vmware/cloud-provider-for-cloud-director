...
func TestDNATRuleCRUDE(t *testing.T) {
	...
	err = gm.createDNATRule(ctx, dnatRuleName, "1.2.3.4", "1.2.3.5", 80, 36123, cloudConfig.ClusterID)
...
func TestLBPoolCRUDE(t *testing.T) {
	...
	lbPoolRef, err := gm.createLoadBalancerPool(ctx, lbPoolName, []string{"1.2.3.4", "1.2.3.5"}, 31234, cloudConfig.ClusterID)
	...
	lbPoolRefUpdated, err := gm.updateLoadBalancerPool(ctx, lbPoolName, updatedIps, 55555, cloudConfig.ClusterID)
	...
	err = gm.deleteLoadBalancerPool(ctx, lbPoolName, true, cloudConfig.ClusterID)
	assert.NoError(t, err, "Unable to delete LB Pool")

	err = gm.deleteLoadBalancerPool(ctx, lbPoolName, true, cloudConfig.ClusterID)
	assert.Error(t, err, "Should fail when deleting non-existing lb pool")

	err = gm.deleteLoadBalancerPool(ctx, lbPoolName, false, cloudConfig.ClusterID)
	...
	lbPoolRef, err = gm.updateLoadBalancerPool(ctx, lbPoolName, updatedIps, 55555, cloudConfig.ClusterID)
...
func TestVirtualServiceHttpCRUDE(t *testing.T) {
	...
	err = gm.updateVirtualServicePort(ctx, virtualServiceName, 8080, externalIP, cloudConfig.ClusterID)
	...
	err = gm.updateVirtualServicePort(ctx, virtualServiceName+"-invalid", 8080, externalIP, cloudConfig.ClusterID)
...
func TestVirtualServiceHttpsCRUDE(t *testing.T) {
	...
	err = gm.updateVirtualServicePort(ctx, virtualServiceName, 8443, externalIP, cloudConfig.ClusterID)
	assert.NoError(t, err, "Unable to update external port")
...
func TestLoadBalancerCRUDE(t *testing.T) {
	...
	err = gm.UpdateLoadBalancer(ctx, lbPoolNamePrefix+"-http", virtualServiceNamePrefix+"-http", updatedIps, updatedInternalPort, 80, cloudConfig.ClusterID)
	assert.NoError(t, err, "HTTP Load Balancer should be updated")

	err = gm.UpdateLoadBalancer(ctx, lbPoolNamePrefix+"-https", virtualServiceNamePrefix+"-https", updatedIps, updatedInternalPort, 443, cloudConfig.ClusterID)
	...
	err = gm.UpdateLoadBalancer(ctx, lbPoolNamePrefix+"-http", virtualServiceNamePrefix+"-http", updatedIps, updatedInternalPort, updatedExternalPortHttp, cloudConfig.ClusterID)
	assert.NoError(t, err, "HTTP Load Balancer should be updated")

	err = gm.UpdateLoadBalancer(ctx, lbPoolNamePrefix+"-https", virtualServiceNamePrefix+"-https", updatedIps, updatedInternalPort, updatedExternalPortHttps, cloudConfig.ClusterID)
	assert.NoError(t, err, "HTTPS Load Balancer should be updated")
	...
	err = gm.UpdateLoadBalancer(ctx, lbPoolNamePrefix+"-https", virtualServiceNamePrefix+"https", updatedIps, updatedInternalPort, 43, cloudConfig.ClusterID)
