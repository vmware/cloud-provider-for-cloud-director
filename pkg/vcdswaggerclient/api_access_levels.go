...
/*
AccessLevelsApiService Get the specified access level.
...
func (a *AccessLevelsApiService) GetAccessLevel(ctx context.Context, accessLevelUrn string) (AccessLevel, *http.Response, error) {
	var (
		...
		localVarReturnValue AccessLevel
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/accessLevels/{accessLevelUrn}"
	localVarPath = strings.Replace(localVarPath, "{"+"accessLevelUrn"+"}", fmt.Sprintf("%v", accessLevelUrn), -1)
...
/*
AccessLevelsApiService Get all access levels.
Get all access levels. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *AccessLevelsApiQueryAccessLevelsOpts - Optional Parameters:
...
func (a *AccessLevelsApiService) QueryAccessLevels(ctx context.Context, page int32, pageSize int32, localVarOptionals *AccessLevelsApiQueryAccessLevelsOpts) (AccessLevels, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AccessLevels
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/accessLevels"
