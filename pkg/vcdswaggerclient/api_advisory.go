...
func (a *AdvisoryApiService) CreateAdvisoryDefinition(ctx context.Context, newAdvisoryDefinition AdvisoryDefinition) (AdvisoryDefinition, *http.Response, error) {
	var (
		...
		localVarReturnValue AdvisoryDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/definitions/advisories"
	...
	// body params
	localVarPostBody = &newAdvisoryDefinition
	if ctx != nil {
...
func (a *AdvisoryApiService) DeleteAdvisoryDefinition(ctx context.Context, advisoryId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/definitions/advisories/{advisoryId}"
	localVarPath = strings.Replace(localVarPath, "{"+"advisoryId"+"}", fmt.Sprintf("%v", advisoryId), -1)
...
func (a *AdvisoryApiService) GetAdvisory(ctx context.Context, advisoryId string) (Advisory, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Advisory
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/advisories/{advisoryId}"
	localVarPath = strings.Replace(localVarPath, "{"+"advisoryId"+"}", fmt.Sprintf("%v", advisoryId), -1)
...
/*
AdvisoryApiService Get a list of all advisories accessible to the user.
 ...
 * @param optional nil or *AdvisoryApiQueryAdvisoriesOpts - Optional Parameters:
...
func (a *AdvisoryApiService) QueryAdvisories(ctx context.Context, page int32, pageSize int32, localVarOptionals *AdvisoryApiQueryAdvisoriesOpts) (Advisories, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Advisories
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/advisories"
...
/*
AdvisoryApiService Get a list of all advisory definitions.
Get a list of all advisory definitions. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *AdvisoryApiQueryAdvisoryDefinitionsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort

@return AdvisoryDefinitions
*/
...
func (a *AdvisoryApiService) QueryAdvisoryDefinitions(ctx context.Context, page int32, pageSize int32, localVarOptionals *AdvisoryApiQueryAdvisoryDefinitionsOpts) (AdvisoryDefinitions, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AdvisoryDefinitions
	)
...
/*
AdvisoryApiService Updates an advisory.
...
func (a *AdvisoryApiService) UpdateAdvisory(ctx context.Context, modifiedAdvisory Advisory, advisoryId string) (Advisory, *http.Response, error) {
	...
	// body params
	localVarPostBody = &modifiedAdvisory
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
