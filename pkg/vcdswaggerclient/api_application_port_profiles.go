...
func (a *ApplicationPortProfilesApiService) CreateApplicationPortProfile(ctx context.Context, applicationPortProfile ApplicationPortProfile) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/applicationPortProfiles"
	...
	// body params
	localVarPostBody = &applicationPortProfile
	if ctx != nil {
...
/*
ApplicationPortProfilesApiService Get all Application Port Profiles.
 ...
 * @param optional nil or *ApplicationPortProfilesApiGetApplicationPortProfilesOpts - Optional Parameters:
...
func (a *ApplicationPortProfilesApiService) GetApplicationPortProfiles(ctx context.Context, page int32, pageSize int32, localVarOptionals *ApplicationPortProfilesApiGetApplicationPortProfilesOpts) (ApplicationPortProfiles, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ApplicationPortProfiles
	)
...
/*
ApplicationPortProfilesApiService Sync the application port profiles from the network provider to VCD.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *ApplicationPortProfilesApiSyncApplicationPortProfilesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
...
func (a *ApplicationPortProfilesApiService) SyncApplicationPortProfiles(ctx context.Context, localVarOptionals *ApplicationPortProfilesApiSyncApplicationPortProfilesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/applicationPortProfiles/sync"
