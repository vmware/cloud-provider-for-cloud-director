...
/*
CodegenPlaceholderApiService This endpoint will not produce results. It is a placeholder to enforce code generation of Page.
...
func (a *CodegenPlaceholderApiService) GetQueryResult(ctx context.Context) (Page, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/query/page"
