...
@return Config
*/
func (a *ConfigurationsApiService) GetConfig(ctx context.Context, urn string) (Config, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/site/configurations/{urn}"
...
/*
ConfigurationsApiService Returns all configuration properties. At present this will always return an EMPTY list.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *ConfigurationsApiGetConfigsOpts - Optional Parameters:
...
func (a *ConfigurationsApiService) GetConfigs(ctx context.Context, page int32, pageSize int32, localVarOptionals *ConfigurationsApiGetConfigsOpts) (Configs, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/site/configurations"
...
func (a *ConfigurationsApiService) SetConfig(ctx context.Context, newConfigValue Config, urn string) (Config, *http.Response, error) {
	...
	// body params
	localVarPostBody = &newConfigValue
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
