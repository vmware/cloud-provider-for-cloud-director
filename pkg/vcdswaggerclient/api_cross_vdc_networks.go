...
func (a *CrossVdcNetworksApiService) CreateCrossVdcNetwork(ctx context.Context, crossVdcNetwork CrossVdcNetwork) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/crossVdcNetworks"
...
/*
CrossVdcNetworksApiService Get all Cross vDC networks in the system.
Get all Cross vDC networks in the system. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *CrossVdcNetworksApiGetAllCrossVdcNetworksOpts - Optional Parameters:
...
func (a *CrossVdcNetworksApiService) GetAllCrossVdcNetworks(ctx context.Context, page int32, pageSize int32, localVarOptionals *CrossVdcNetworksApiGetAllCrossVdcNetworksOpts) (CrossVdcNetworks, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CrossVdcNetworks
	)
...
/*
CrossVdcNetworksApiService Get all Cross vDC networks of a vDC group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param vdcGroupId
 * @param optional nil or *CrossVdcNetworksApiGetAllCrossVdcNetworksForVdcGroupOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *CrossVdcNetworksApiService) GetAllCrossVdcNetworksForVdcGroup(ctx context.Context, page int32, pageSize int32, vdcGroupId string, localVarOptionals *CrossVdcNetworksApiGetAllCrossVdcNetworksForVdcGroupOpts) (CrossVdcNetworks, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/{vdcGroupId}/crossVdcNetworks"
