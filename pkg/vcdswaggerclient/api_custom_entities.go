...
/*
CustomEntitiesApiService Creates a new custom entity type
...
func (a *CustomEntitiesApiService) CreateCustomEntityType(ctx context.Context, newCustomEntityType CustomEntityType) (CustomEntityType, *http.Response, error) {
	var (
		...
		localVarReturnValue CustomEntityType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes"
	...
	// body params
	localVarPostBody = &newCustomEntityType
	if ctx != nil {
...
/*
CustomEntitiesApiService Creates a new custom entity type action.
...
func (a *CustomEntitiesApiService) CreateCustomEntityTypeAction(ctx context.Context, newCustomEntityTypeAction CreateCustomEntityTypeAction, customEntityTypeId string) (CustomEntityTypeAction, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CustomEntityTypeAction
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/actions"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
	...
	// body params
	localVarPostBody = &newCustomEntityTypeAction
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
func (a *CustomEntitiesApiService) DeleteCustomEntityType(ctx context.Context, recursive bool, customEntityTypeId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
func (a *CustomEntitiesApiService) DeleteCustomEntityTypeAction(ctx context.Context, customEntityTypeId string, workflowId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/actions/{workflowId}"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Get list of all custom entities
Get list of custom entities 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *CustomEntitiesApiGetCustomEntitiesOpts - Optional Parameters:
...
func (a *CustomEntitiesApiService) GetCustomEntities(ctx context.Context, localVarOptionals *CustomEntitiesApiGetCustomEntitiesOpts) (CustomEntities, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CustomEntities
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntities"
...
func (a *CustomEntitiesApiService) GetCustomEntity(ctx context.Context, customEntityId string) (CustomEntity, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntities/{customEntityId}"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityId"+"}", fmt.Sprintf("%v", customEntityId), -1)
...
func (a *CustomEntitiesApiService) GetCustomEntityAsSdkObject(ctx context.Context, customEntityId string) (SdkObject, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SdkObject
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntities/{customEntityId}/sdkObject"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityId"+"}", fmt.Sprintf("%v", customEntityId), -1)
...
func (a *CustomEntitiesApiService) GetCustomEntityTypeActions(ctx context.Context, customEntityTypeId string) (CustomEntityTypeActions, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CustomEntityTypeActions
	)
...
/*
CustomEntitiesApiService Retrieves list of tenants for whom the custom entity type is explicitly published
...
func (a *CustomEntitiesApiService) GetCustomEntityTypeTenants(ctx context.Context, customEntityTypeId string) ([]EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/tenants"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Publishes the custom entity type to the specified tenants
...
func (a *CustomEntitiesApiService) PostCustomEntityTypePublish(ctx context.Context, publishTenantsBody []EntityReference, customEntityTypeId string) ([]EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/tenants/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Publishes the custom entity type to all tenants
...
func (a *CustomEntitiesApiService) PostCustomEntityTypePublishAll(ctx context.Context, customEntityTypeId string) ([]EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/tenants/publishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Revokes publication of the custom entity type to the specified tenants
...
func (a *CustomEntitiesApiService) PostCustomEntityTypeUnpublish(ctx context.Context, unpublishTenantsBody []EntityReference, customEntityTypeId string) ([]EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/tenants/unpublish"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Unpublishes the custom entity type from all tenants
...
func (a *CustomEntitiesApiService) PostCustomEntityTypeUnpublishAll(ctx context.Context, customEntityTypeId string) ([]EntityReference, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/customEntityTypes/{customEntityTypeId}/tenants/unpublishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"customEntityTypeId"+"}", fmt.Sprintf("%v", customEntityTypeId), -1)
...
/*
CustomEntitiesApiService Get list of all custom entity types
Get list of custom entity types. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *CustomEntitiesApiQueryCustomEntityTypesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *CustomEntitiesApiService) QueryCustomEntityTypes(ctx context.Context, page int32, pageSize int32, localVarOptionals *CustomEntitiesApiQueryCustomEntityTypesOpts) (CustomEntityTypes, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue CustomEntityTypes
	)
...
/*
CustomEntitiesApiService Resets list of tenants for whom the custom entity type is explicitly published
...
func (a *CustomEntitiesApiService) UpdateCustomEntityType(ctx context.Context, updatedCustomEntityType CustomEntityType, customEntityTypeId string) (CustomEntityType, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updatedCustomEntityType
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
