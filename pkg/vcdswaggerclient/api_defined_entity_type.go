...
/*
DefinedEntityTypeApiService Creates a defined entity type.
...
func (a *DefinedEntityTypeApiService) CreateDefinedEntityType(ctx context.Context, definition DefinedEntityType) (DefinedEntityType, *http.Response, error) {
	var (
		...
		localVarReturnValue DefinedEntityType
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/entityTypes/"
...
/*
DefinedEntityTypeApiService Deletes the entity type with the unique identifier (URN)
...
/*
DefinedEntityTypeApiService Gets the entity type with the unique identifier (URN)
...
/*
DefinedEntityTypeApiService Gets the collection of entity types defined in the vCD instance. Allows collection refinement through traditional FIQL-based filtering
 ...
 * @param optional nil or *DefinedEntityTypeApiGetDefinedEntityTypesOpts - Optional Parameters:
...
func (a *DefinedEntityTypeApiService) GetDefinedEntityTypes(ctx context.Context, page int32, pageSize int32, localVarOptionals *DefinedEntityTypeApiGetDefinedEntityTypesOpts) (DefinedEntityTypes, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DefinedEntityTypes
	)
...
/*
DefinedEntityTypeApiService Updates the entity type with the unique identifier (URN)
