...
/*
DefinedInterfaceApiService Creates a defined interface.
...
func (a *DefinedInterfaceApiService) CreateInterface(ctx context.Context, definedInterface DefinedInterface) (DefinedInterface, *http.Response, error) {
	var (
		...
		localVarReturnValue DefinedInterface
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/interfaces"
	...
	// body params
	localVarPostBody = &definedInterface
	if ctx != nil {
...
/*
DefinedInterfaceApiService Deletes the interface with the unique identifier (URN)
...
func (a *DefinedInterfaceApiService) DeleteInterface(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/interfaces/{id}"
...
/*
DefinedInterfaceApiService Gets the interface with the unique identifier (URN)
...
@return DefinedInterface
*/
func (a *DefinedInterfaceApiService) GetInterface(ctx context.Context, id string) (DefinedInterface, *http.Response, error) {
	var (
...
/*
DefinedInterfaceApiService Gets the collection of interfaces defined in the vCD instance. Allows collection refinement through traditional FIQL-based filtering
 ...
 * @param optional nil or *DefinedInterfaceApiQueryInterfacesOpts - Optional Parameters:
...
func (a *DefinedInterfaceApiService) QueryInterfaces(ctx context.Context, page int32, pageSize int32, localVarOptionals *DefinedInterfaceApiQueryInterfacesOpts) (DefinedInterfaces, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DefinedInterfaces
	)
...
/*
DefinedInterfaceApiService Updates the interface with the unique identifier (URN)
