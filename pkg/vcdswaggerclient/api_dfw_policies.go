...
/*
DfwPoliciesApiService Retrieves DFW security policies configuration.
...
func (a *DfwPoliciesApiService) GetDfwPolicies(ctx context.Context, vdcGroupId string) (DfwPolicies, *http.Response, error) {
	var (
		...
		localVarReturnValue DfwPolicies
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/{vdcGroupId}/dfwPolicies"
...
/*
DfwPoliciesApiService Update DFW security policies configuration.
