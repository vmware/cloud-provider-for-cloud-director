...
/*
EdgeGatewayBgpApiService Retrieves the BGP configuration for a given Edge Gateway.
...
func (a *EdgeGatewayBgpApiService) GetBgpConfig(ctx context.Context, gatewayId string) (EdgeBgpConfig, *http.Response, error) {
	var (
		...
		localVarReturnValue EdgeBgpConfig
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/bgp"
...
/*
EdgeGatewayBgpApiService Updates the BGP configuration on the Edge Gateway.
