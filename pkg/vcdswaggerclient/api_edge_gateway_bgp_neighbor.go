...
func (a *EdgeGatewayBgpNeighborApiService) DeleteBgpNeighbor(ctx context.Context, gatewayId string, neighborId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/bgp/neighbors/{neighborId}"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", fmt.Sprintf("%v", gatewayId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"neighborId"+"}", fmt.Sprintf("%v", neighborId), -1)
...
func (a *EdgeGatewayBgpNeighborApiService) GetBgpNeighbor(ctx context.Context, gatewayId string, neighborId string) (EdgeBgpNeighbor, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeBgpNeighbor
	)
...
func (a *EdgeGatewayBgpNeighborApiService) GetBgpNeighborStatus(ctx context.Context, gatewayId string, neighborId string) (NetworkingObjectStatus, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NetworkingObjectStatus
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/bgp/neighbors/{neighborId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", fmt.Sprintf("%v", gatewayId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"neighborId"+"}", fmt.Sprintf("%v", neighborId), -1)
