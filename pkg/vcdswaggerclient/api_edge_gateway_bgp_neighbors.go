...
func (a *EdgeGatewayBgpNeighborsApiService) CreateBgpNeighbor(ctx context.Context, bgpNeighbor EdgeBgpNeighbor, gatewayId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/bgp/neighbors"
...
*/
func (a *EdgeGatewayBgpNeighborsApiService) GetBgpNeighbors(ctx context.Context, gatewayId string) (EdgeBgpNeighbors, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeBgpNeighbors
	)
