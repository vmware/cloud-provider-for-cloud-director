...
/*
EdgeGatewayDhcpApiService Retrieves DHCP Forwarder configuration on an Edge Gateway.
...
func (a *EdgeGatewayDhcpApiService) GetDhcpForwarder(ctx context.Context, gatewayId string) (EdgeDhcpForwarder, *http.Response, error) {
	var (
		...
		localVarReturnValue EdgeDhcpForwarder
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/dhcpForwarder"
...
/*
EdgeGatewayDhcpApiService Update DHCP Forwarder configuration on an Edge Gateway.
...
func (a *EdgeGatewayDhcpApiService) UpdateDhcpForwarder(ctx context.Context, dhcpForwarder EdgeDhcpForwarder, gatewayId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &dhcpForwarder
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
