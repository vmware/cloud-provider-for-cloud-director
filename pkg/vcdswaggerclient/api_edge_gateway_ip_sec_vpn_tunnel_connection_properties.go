...
*/
func (a *EdgeGatewayIpSecVpnTunnelConnectionPropertiesApiService) GetIpSecVpnTunnelConnectionProperties(ctx context.Context, gatewayId string, tunnelId string) (EdgeIpSecVpnTunnelConnectionProperties, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/ipsec/tunnels/{tunnelId}/connectionProperties"
...
func (a *EdgeGatewayIpSecVpnTunnelConnectionPropertiesApiService) UpdateIpSecVpnTunnelConnectionProperties(ctx context.Context, ipSecVpnTunnelConnectionProperties EdgeIpSecVpnTunnelConnectionProperties, gatewayId string, tunnelId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &ipSecVpnTunnelConnectionProperties
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
