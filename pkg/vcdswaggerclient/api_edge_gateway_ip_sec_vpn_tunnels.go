...
func (a *EdgeGatewayIpSecVpnTunnelsApiService) CreateIpSecVpnTunnel(ctx context.Context, ipsecVpnTunnel EdgeIpSecVpnTunnel, gatewayId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/ipsec/tunnels"
...
/*
EdgeGatewayIpSecVpnTunnelsApiService Retrieves all IPSec tunnels for a given edge gateway.
 ...
 * @param gatewayId
 * @param optional nil or *EdgeGatewayIpSecVpnTunnelsApiGetIpSecVpnTunnelsOpts - Optional Parameters:
...
func (a *EdgeGatewayIpSecVpnTunnelsApiService) GetIpSecVpnTunnels(ctx context.Context, pageSize int32, gatewayId string, localVarOptionals *EdgeGatewayIpSecVpnTunnelsApiGetIpSecVpnTunnelsOpts) (EdgeIpSecVpnTunnels, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeIpSecVpnTunnels
	)
