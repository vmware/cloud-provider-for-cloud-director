...
func (a *EdgeGatewayL2VpnTunnelApiService) DeleteL2VpnTunnel(ctx context.Context, gatewayId string, tunnelId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/l2vpn/tunnels/{tunnelId}"
...
func (a *EdgeGatewayL2VpnTunnelApiService) GetL2VpnTunnel(ctx context.Context, gatewayId string, tunnelId string) (EdgeL2VpnTunnel, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeL2VpnTunnel
	)
...
func (a *EdgeGatewayL2VpnTunnelApiService) GetL2VpnTunnelStatistics(ctx context.Context, gatewayId string, tunnelId string) (EdgeL2VpnTunnelStatistics, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeL2VpnTunnelStatistics
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/l2vpn/tunnels/{tunnelId}/metrics"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", fmt.Sprintf("%v", gatewayId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tunnelId"+"}", fmt.Sprintf("%v", tunnelId), -1)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EdgeL2VpnTunnelStatistics
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
func (a *EdgeGatewayL2VpnTunnelApiService) GetL2VpnTunnelStatus(ctx context.Context, gatewayId string, tunnelId string) (EdgeL2VpnTunnelStatus, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeL2VpnTunnelStatus
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/l2vpn/tunnels/{tunnelId}/status"
	localVarPath = strings.Replace(localVarPath, "{"+"gatewayId"+"}", fmt.Sprintf("%v", gatewayId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"tunnelId"+"}", fmt.Sprintf("%v", tunnelId), -1)
