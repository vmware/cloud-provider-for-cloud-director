...
func (a *EdgeGatewayL2VpnTunnelsApiService) CreateL2VpnTunnel(ctx context.Context, l2VpnTunnel EdgeL2VpnTunnel, gatewayId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/l2vpn/tunnels"
...
/*
EdgeGatewayL2VpnTunnelsApiService Retrieves all L2 VPN tunnels for a given edge gateway.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gatewayId
 * @param optional nil or *EdgeGatewayL2VpnTunnelsApiGetL2VpnTunnelsOpts - Optional Parameters:
...
func (a *EdgeGatewayL2VpnTunnelsApiService) GetL2VpnTunnels(ctx context.Context, gatewayId string, localVarOptionals *EdgeGatewayL2VpnTunnelsApiGetL2VpnTunnelsOpts) (EdgeL2VpnTunnels, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeL2VpnTunnels
	)
