...
/*
EdgeGatewayLoadBalancerApiService Retrieves Load Balancer configuration on an Edge Gateway.
...
*/
func (a *EdgeGatewayLoadBalancerApiService) GetLoadBalancerConfig(ctx context.Context, gatewayId string) (EdgeGatewayLoadBalancerConfig, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgeGatewayLoadBalancerConfig
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/loadBalancer"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v EdgeGatewayLoadBalancerConfig
...
/*
EdgeGatewayLoadBalancerApiService Update Load Balancer configuration on an Edge Gateway.
...
func (a *EdgeGatewayLoadBalancerApiService) UpdateLoadBalancerConfig(ctx context.Context, loadBalancerConfig EdgeGatewayLoadBalancerConfig, gatewayId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &loadBalancerConfig
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
