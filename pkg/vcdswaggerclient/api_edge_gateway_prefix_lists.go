...
func (a *EdgeGatewayPrefixListsApiService) CreatePrefixList(ctx context.Context, prefixList EdgePrefixList, gatewayId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/bgp/prefixLists"
...
/*
EdgeGatewayPrefixListsApiService Retrieves all Prefix lists for a given edge gateway.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param gatewayId
 * @param optional nil or *EdgeGatewayPrefixListsApiGetPrefixListsOpts - Optional Parameters:
...
func (a *EdgeGatewayPrefixListsApiService) GetPrefixLists(ctx context.Context, gatewayId string, localVarOptionals *EdgeGatewayPrefixListsApiGetPrefixListsOpts) (EdgePrefixLists, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EdgePrefixLists
	)
