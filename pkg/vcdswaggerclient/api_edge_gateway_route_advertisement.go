...
/*
EdgeGatewayRouteAdvertisementApiService Retrieve the list of subnets that will be advertised so that the Edge Gateway can route out to the connected external network.
...
*/
func (a *EdgeGatewayRouteAdvertisementApiService) GetRouteAdvertisement(ctx context.Context, gatewayId string) (RouteAdvertisement, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RouteAdvertisement
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/routing/advertisement"
...
func (a *EdgeGatewayRouteAdvertisementApiService) UpdateRouteAdvertisement(ctx context.Context, routeAdvertisement RouteAdvertisement, gatewayId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &routeAdvertisement
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
