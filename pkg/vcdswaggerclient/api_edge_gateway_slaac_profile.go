...
/*
EdgeGatewaySLAACProfileApiService Retrieves the SLAAC profile on the edge gateway. 
...
func (a *EdgeGatewaySLAACProfileApiService) GetSLAACProfile(ctx context.Context, gatewayId string) (SlaacProfile, *http.Response, error) {
	var (
		...
		localVarReturnValue SlaacProfile
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/edgeGateways/{gatewayId}/slaacProfile"
