...
/*
EgressPointApiService Deletes a specific Universal Egress Point.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param universalRouterId
 * @param egressPointId
 * @param optional nil or *EgressPointApiDeleteEgressPointOpts - Optional Parameters:
...
func (a *EgressPointApiService) DeleteEgressPoint(ctx context.Context, universalRouterId string, egressPointId string, localVarOptionals *EgressPointApiDeleteEgressPointOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/routing/egressPoints/{egressPointId}"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"egressPointId"+"}", fmt.Sprintf("%v", egressPointId), -1)
...
func (a *EgressPointApiService) GetEgressPoint(ctx context.Context, universalRouterId string, egressPointId string) (EgressPoint, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EgressPoint
	)
...
func (a *EgressPointApiService) SyncEgressPoint(ctx context.Context, universalRouterId string, egressPointId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/routing/egressPoints/{egressPointId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
	localVarPath = strings.Replace(localVarPath, "{"+"egressPointId"+"}", fmt.Sprintf("%v", egressPointId), -1)
