...
func (a *ExternalNetworkApiService) CreateExternalNetwork(ctx context.Context, externalNetwork ExternalNetwork) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks"
	...
	// body params
	localVarPostBody = &externalNetwork
	if ctx != nil {
...
/*
ExternalNetworkApiService Deletes a specific external network.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param externalNetworkId
 * @param optional nil or *ExternalNetworkApiDeleteExternalNetworkOpts - Optional Parameters:
...
func (a *ExternalNetworkApiService) DeleteExternalNetwork(ctx context.Context, externalNetworkId string, localVarOptionals *ExternalNetworkApiDeleteExternalNetworkOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks/{externalNetworkId}"
	localVarPath = strings.Replace(localVarPath, "{"+"externalNetworkId"+"}", fmt.Sprintf("%v", externalNetworkId), -1)
...
/*
ExternalNetworkApiService Retrieve the list of IP addresses available for use on the network.
...
func (a *ExternalNetworkApiService) GetAvailableIpAddresses(ctx context.Context, externalNetworkId string) (AvailableIpPoolSubnets, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AvailableIpPoolSubnets
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks/{externalNetworkId}/availableIpAddresses"
	localVarPath = strings.Replace(localVarPath, "{"+"externalNetworkId"+"}", fmt.Sprintf("%v", externalNetworkId), -1)
...
func (a *ExternalNetworkApiService) GetExternalNetwork(ctx context.Context, externalNetworkId string) (ExternalNetwork, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ExternalNetwork
	)
...
/*
ExternalNetworkApiService Retrieve the list of IP addresses which are being used from the network.
 ...
 * @param externalNetworkId
 * @param optional nil or *ExternalNetworkApiGetUsedIpAddressesOpts - Optional Parameters:
...
func (a *ExternalNetworkApiService) GetUsedIpAddresses(ctx context.Context, page int32, pageSize int32, externalNetworkId string, localVarOptionals *ExternalNetworkApiGetUsedIpAddressesOpts) (UsedIpAddresses, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UsedIpAddresses
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/externalNetworks/{externalNetworkId}/usedIpAddresses"
	localVarPath = strings.Replace(localVarPath, "{"+"externalNetworkId"+"}", fmt.Sprintf("%v", externalNetworkId), -1)
