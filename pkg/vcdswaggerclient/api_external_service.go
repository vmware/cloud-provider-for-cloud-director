...
/*
ExternalServiceApiService Create external service.
...
func (a *ExternalServiceApiService) CreateExternalService(ctx context.Context, service ExternalService) (ExternalService, *http.Response, error) {
	var (
		...
		localVarReturnValue ExternalService
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/api"
...
/*
ExternalServiceApiService Delete an external service.
...
func (a *ExternalServiceApiService) DeleteExternalService(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/api/{id}"
...
/*
ExternalServiceApiService Retrieve an external service.
...
/*
ExternalServiceApiService Query external services.
 ...
 * @param optional nil or *ExternalServiceApiGetExternalServicesOpts - Optional Parameters:
...
func (a *ExternalServiceApiService) GetExternalServices(ctx context.Context, page int32, pageSize int32, localVarOptionals *ExternalServiceApiGetExternalServicesOpts) (ExternalServices, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ExternalServices
	)
...
/*
ExternalServiceApiService Update an external service.
