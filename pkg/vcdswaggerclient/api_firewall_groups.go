...
/*
FirewallGroupsApiService Create a firewall group
...
func (a *FirewallGroupsApiService) CreateFirewallGroup(ctx context.Context, firewallGroup FirewallGroupDetails) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/firewallGroups"
...
/*
FirewallGroupsApiService Retrieves the Firewall Groups.
 ...
 * @param optional nil or *FirewallGroupsApiGetFirewallGroupsOpts - Optional Parameters:
...
func (a *FirewallGroupsApiService) GetFirewallGroups(ctx context.Context, page int32, pageSize int32, localVarOptionals *FirewallGroupsApiGetFirewallGroupsOpts) (FirewallGroups, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue FirewallGroups
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/firewallGroups/summaries"
