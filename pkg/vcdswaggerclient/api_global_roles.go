...
/*
GlobalRolesApiService Adds the specified rights to a global role.
...
func (a *GlobalRolesApiService) AddRightsToGlobalRole(ctx context.Context, rightsReferencesBody EntityReferences, id string) (EntityReferences, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/rights"
...
/*
GlobalRolesApiService Creates a new global role
...
func (a *GlobalRolesApiService) CreateGlobalRole(ctx context.Context, newGlobalRole GlobalRole) (GlobalRole, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles"
	...
	// body params
	localVarPostBody = &newGlobalRole
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
func (a *GlobalRolesApiService) DeleteGlobalRole(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Publishes the global role to the specified tenants
...
func (a *GlobalRolesApiService) PostGlobalRolePublish(ctx context.Context, publishTenantsBody EntityReferences, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/tenants/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Publishes the global role to all tenants
...
func (a *GlobalRolesApiService) PostGlobalRolePublishAll(ctx context.Context, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/tenants/publishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Revokes publication of the global role to the specified tenants
...
func (a *GlobalRolesApiService) PostGlobalRoleUnpublish(ctx context.Context, unpublishTenantsBody EntityReferences, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/tenants/unpublish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Unpublishes the global role from all tenants
...
func (a *GlobalRolesApiService) PostGlobalRoleUnpublishAll(ctx context.Context, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/tenants/unpublishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Gets a paged list of rights (as references) contained by a particular global role
 ...
 * @param id
 * @param optional nil or *GlobalRolesApiQueryGlobalRoleRightsOpts - Optional Parameters:
...
/*
GlobalRolesApiService Retrieves list of tenants for whom the global role is explicitly published
Retrieves list of tenants for whom the global role is explicitly published 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param id
 * @param optional nil or *GlobalRolesApiQueryGlobalRoleTenantsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *GlobalRolesApiService) QueryGlobalRoleTenants(ctx context.Context, page int32, pageSize int32, id string, localVarOptionals *GlobalRolesApiQueryGlobalRoleTenantsOpts) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/globalRoles/{id}/tenants"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
GlobalRolesApiService Get list of global roles
Get list of global roles 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *GlobalRolesApiQueryGlobalRolesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *GlobalRolesApiService) QueryGlobalRoles(ctx context.Context, page int32, pageSize int32, localVarOptionals *GlobalRolesApiQueryGlobalRolesOpts) (GlobalRoles, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue GlobalRoles
	)
...
/*
GlobalRolesApiService Replaces the existing set of rights in global role with the rights (as references) supplied.
...
/*
GlobalRolesApiService Resets list of tenants for whom the global role is explicitly published
...
func (a *GlobalRolesApiService) UpdateGlobalRole(ctx context.Context, updatedGlobalRole GlobalRole, id string) (GlobalRole, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updatedGlobalRole
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
