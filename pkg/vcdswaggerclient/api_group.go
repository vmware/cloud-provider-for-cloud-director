...
func (a *GroupApiService) CreateGroup(ctx context.Context, newGroup UserGroup) (UserGroup, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/groups"
...
func (a *GroupApiService) DeleteGroup(ctx context.Context, groupUrn string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/groups/{groupUrn}"
...
/*
GroupApiService Get a list of users of any type that belong to the specified group.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param groupUrn groupUrn
 * @param optional nil or *GroupApiQueryGroupUsersOpts - Optional Parameters:
...
func (a *GroupApiService) QueryGroupUsers(ctx context.Context, page int32, pageSize int32, groupUrn string, localVarOptionals *GroupApiQueryGroupUsersOpts) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/groups/{groupUrn}/users"
	localVarPath = strings.Replace(localVarPath, "{"+"groupUrn"+"}", fmt.Sprintf("%v", groupUrn), -1)
...
/*
GroupApiService Get a list of groups.
Get a list of groups. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *GroupApiQueryGroupsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
/*
GroupApiService Modify the details of the specified group.
