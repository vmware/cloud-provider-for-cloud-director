...
func (a *K8sClusterApiService) CreateK8sCluster(ctx context.Context, k8sCluster Cluster) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tkgClusters"
...
func (a *K8sClusterApiService) DeleteK8sCluster(ctx context.Context, urn string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tkgClusters/{urn}"
...
func (a *K8sClusterApiService) GenerateKubeconfig(ctx context.Context, urn string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tkgClusters/{urn}/kubeconfig"
	localVarPath = strings.Replace(localVarPath, "{"+"urn"+"}", fmt.Sprintf("%v", urn), -1)
...
/*
K8sClusterApiService Retrieves all K8s clusters
Retrieves all K8s clusters 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *K8sClusterApiQueryK8sClustersOpts - Optional Parameters:
