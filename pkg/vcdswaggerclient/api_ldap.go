...
/*
LDAPApiService Search LDAP Groups
Searches LDAP for given group(s) 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LDAPApiSearchLdapGroupsOpts - Optional Parameters:
     * @param "Q" (optional.String) -  String to search for via LDAP
...
func (a *LDAPApiService) SearchLdapGroups(ctx context.Context, localVarOptionals *LDAPApiSearchLdapGroupsOpts) ([]UserGroup, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ldap/search/group"
...
/*
LDAPApiService Search LDAP Users
Searches LDAP for given user(s) 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *LDAPApiSearchLdapUsersOpts - Optional Parameters:
     * @param "Q" (optional.String) -  String to search for via LDAP
...
func (a *LDAPApiService) SearchLdapUsers(ctx context.Context, localVarOptionals *LDAPApiSearchLdapUsersOpts) ([]User, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ldap/search/user"
...
/*
LDAPApiService Synchronize LDAP users/settings
...
func (a *LDAPApiService) SyncLdap(ctx context.Context) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ldap/sync"
...
/*
LDAPApiService Tests LDAP Connection and Settings
 ...
 * @param optional nil or *LDAPApiTestLdapOpts - Optional Parameters:
     * @param "Username" (optional.String) -  Username to use when testing LDAP search
...
func (a *LDAPApiService) TestLdap(ctx context.Context, ldapSettings LdapSettings, localVarOptionals *LDAPApiTestLdapOpts) (LdapTestResult, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LdapTestResult
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ldap/test"
