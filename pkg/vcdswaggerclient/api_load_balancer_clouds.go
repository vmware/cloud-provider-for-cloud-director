...
/*
LoadBalancerCloudsApiService Get all registered Load Balancer Clouds in the system.
 ...
 * @param optional nil or *LoadBalancerCloudsApiGetLoadBalancerCloudsOpts - Optional Parameters:
...
func (a *LoadBalancerCloudsApiService) GetLoadBalancerClouds(ctx context.Context, page int32, pageSize int32, localVarOptionals *LoadBalancerCloudsApiGetLoadBalancerCloudsOpts) (LoadBalancerClouds, *http.Response, error) {
	var (
		...
		localVarReturnValue LoadBalancerClouds
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/clouds"
...
/*
LoadBalancerCloudsApiService Register a new Load Balancer Cloud.
