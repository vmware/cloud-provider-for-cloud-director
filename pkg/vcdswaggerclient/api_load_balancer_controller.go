...
/*
LoadBalancerControllerApiService Get Load Balancer Controller
...
func (a *LoadBalancerControllerApiService) GetLoadBalancerController(ctx context.Context, loadBalancerControllerId string) (LoadBalancerController, *http.Response, error) {
	var (
		...
		localVarReturnValue LoadBalancerController
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/controllers/{loadBalancerControllerId}"
	localVarPath = strings.Replace(localVarPath, "{"+"loadBalancerControllerId"+"}", fmt.Sprintf("%v", loadBalancerControllerId), -1)
...
/*
LoadBalancerControllerApiService Unregister the specified Load Balancer Controller.
...
/*
LoadBalancerControllerApiService Update specified Load Balancer Controller
