...
/*
LoadBalancerControllersApiService Get all registered Load Balancer Controllers in the system.
 ...
 * @param optional nil or *LoadBalancerControllersApiGetLoadBalancerControllersOpts - Optional Parameters:
...
func (a *LoadBalancerControllersApiService) GetLoadBalancerControllers(ctx context.Context, page int32, pageSize int32, localVarOptionals *LoadBalancerControllersApiGetLoadBalancerControllersOpts) (LoadBalancerControllers, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LoadBalancerControllers
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/controllers"
...
/*
LoadBalancerControllersApiService Register a new Load Balancer Controller
...
func (a *LoadBalancerControllersApiService) RegisterLoadBalancerController(ctx context.Context, loadBalancerController LoadBalancerController) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &loadBalancerController
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
