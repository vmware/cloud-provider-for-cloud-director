...
/*
LoadBalancerServiceEngineGroupApiService Delete the specified Load Balancer Service Engine Group.
...
func (a *LoadBalancerServiceEngineGroupApiService) DeleteServiceEngineGroup(ctx context.Context, loadBalancerServiceEngineGroupId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/serviceEngineGroups/{loadBalancerServiceEngineGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"loadBalancerServiceEngineGroupId"+"}", fmt.Sprintf("%v", loadBalancerServiceEngineGroupId), -1)
...
/*
LoadBalancerServiceEngineGroupApiService Get Load Balancer Service Engine Group.
...
func (a *LoadBalancerServiceEngineGroupApiService) GetServiceEngineGroup(ctx context.Context, loadBalancerServiceEngineGroupId string) (LoadBalancerServiceEngineGroup, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LoadBalancerServiceEngineGroup
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LoadBalancerServiceEngineGroup
...
/*
LoadBalancerServiceEngineGroupApiService Sync Load Balancer Service Engine Group.
...
func (a *LoadBalancerServiceEngineGroupApiService) SyncServiceEngineGroup(ctx context.Context, loadBalancerServiceEngineGroupId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/serviceEngineGroups/{loadBalancerServiceEngineGroupId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"loadBalancerServiceEngineGroupId"+"}", fmt.Sprintf("%v", loadBalancerServiceEngineGroupId), -1)
...
/*
LoadBalancerServiceEngineGroupApiService Update specified Load Balancer Service Engine Group.
...
func (a *LoadBalancerServiceEngineGroupApiService) UpdateServiceEngineGroup(ctx context.Context, loadBalancerServiceEngineGroup LoadBalancerServiceEngineGroup, loadBalancerServiceEngineGroupId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &loadBalancerServiceEngineGroup
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
