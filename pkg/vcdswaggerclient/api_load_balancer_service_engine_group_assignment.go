...
/*
LoadBalancerServiceEngineGroupAssignmentApiService Delete the specified Load Balancer Service Engine Group Assignment.
...
func (a *LoadBalancerServiceEngineGroupAssignmentApiService) DeleteServiceEngineGroupAssignment(ctx context.Context, assignmentId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/serviceEngineGroups/assignments/{assignmentId}"
	localVarPath = strings.Replace(localVarPath, "{"+"assignmentId"+"}", fmt.Sprintf("%v", assignmentId), -1)
...
/*
LoadBalancerServiceEngineGroupAssignmentApiService Get a Load Balancer Service Engine Group Assignment.
...
*/
func (a *LoadBalancerServiceEngineGroupAssignmentApiService) GetServiceEngineGroupAssignment(ctx context.Context, assignmentId string) (LoadBalancerServiceEngineGroupAssignment, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LoadBalancerServiceEngineGroupAssignment
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LoadBalancerServiceEngineGroupAssignment
...
/*
LoadBalancerServiceEngineGroupAssignmentApiService Update a Load Balancer Service Engine Group Assignment.
