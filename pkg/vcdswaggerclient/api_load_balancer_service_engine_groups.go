...
/*
LoadBalancerServiceEngineGroupsApiService Create a new Load Balancer Service Engine Group.
...
func (a *LoadBalancerServiceEngineGroupsApiService) CreateServiceEngineGroup(ctx context.Context, loadBalancerServiceEngineGroup LoadBalancerServiceEngineGroup) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/loadBalancer/serviceEngineGroups"
...
/*
LoadBalancerServiceEngineGroupsApiService Get all Load Balancer Service Engine Groups in the system.
 ...
 * @param optional nil or *LoadBalancerServiceEngineGroupsApiGetServiceEngineGroupsOpts - Optional Parameters:
...
func (a *LoadBalancerServiceEngineGroupsApiService) GetServiceEngineGroups(ctx context.Context, page int32, pageSize int32, localVarOptionals *LoadBalancerServiceEngineGroupsApiGetServiceEngineGroupsOpts) (LoadBalancerServiceEngineGroups, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LoadBalancerServiceEngineGroups
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v LoadBalancerServiceEngineGroups
