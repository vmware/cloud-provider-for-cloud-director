...
func (a *LogicalVmGroupsApiService) AddNamedVmGroupsToLogicalVmGroup(ctx context.Context, namedVmGroupRefs []EntityReference, logicalVmGroupId string) ([]EntityReference, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/logicalVmGroups/{logicalVmGroupId}/namedVmGroups"
	localVarPath = strings.Replace(localVarPath, "{"+"logicalVmGroupId"+"}", fmt.Sprintf("%v", logicalVmGroupId), -1)
	...
	// body params
	localVarPostBody = &namedVmGroupRefs
	if ctx != nil {
...
/*
LogicalVmGroupsApiService Creates a new logical vm group
...
func (a *LogicalVmGroupsApiService) CreateLogicalVmGroup(ctx context.Context, newLogicalVmGroupParams LogicalVmGroup) (LogicalVmGroup, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LogicalVmGroup
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/logicalVmGroups"
	...
	// body params
	localVarPostBody = &newLogicalVmGroupParams
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
func (a *LogicalVmGroupsApiService) DeleteLogicalVmGroup(ctx context.Context, logicalVmGroupId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/logicalVmGroups/{logicalVmGroupId}"
	localVarPath = strings.Replace(localVarPath, "{"+"logicalVmGroupId"+"}", fmt.Sprintf("%v", logicalVmGroupId), -1)
...
/*
LogicalVmGroupsApiService Get all named vm groups associated with logical vm group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param logicalVmGroupId
 * @param optional nil or *LogicalVmGroupsApiGetLogicalVmGroupNamedVmGroupsOpts - Optional Parameters:
...
/*
LogicalVmGroupsApiService Get all pvdc policies associated with logical vm group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param logicalVmGroupId
 * @param optional nil or *LogicalVmGroupsApiGetPvdcPoliciesForLogicalVmGroupOpts - Optional Parameters:
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *LogicalVmGroupsApiService) GetPvdcPoliciesForLogicalVmGroup(ctx context.Context, page int32, pageSize int32, logicalVmGroupId string, localVarOptionals *LogicalVmGroupsApiGetPvdcPoliciesForLogicalVmGroupOpts) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/logicalVmGroups/{logicalVmGroupId}/pvdcPolicies"
	localVarPath = strings.Replace(localVarPath, "{"+"logicalVmGroupId"+"}", fmt.Sprintf("%v", logicalVmGroupId), -1)
...
/*
LogicalVmGroupsApiService Get list of logical vm groups.
Get list of logical vm groups. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *LogicalVmGroupsApiQueryLogicalVmGroupsOpts - Optional Parameters:
...
func (a *LogicalVmGroupsApiService) QueryLogicalVmGroups(ctx context.Context, page int32, pageSize int32, localVarOptionals *LogicalVmGroupsApiQueryLogicalVmGroupsOpts) (LogicalVmGroups, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue LogicalVmGroups
	)
...
func (a *LogicalVmGroupsApiService) UpdateLogicalVmGroup(ctx context.Context, updateLogicalVmGroupParams LogicalVmGroup, logicalVmGroupId string) (LogicalVmGroup, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updateLogicalVmGroupParams
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
