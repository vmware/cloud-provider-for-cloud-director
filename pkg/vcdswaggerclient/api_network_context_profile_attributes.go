...
/*
NetworkContextProfileAttributesApiService List all supported network context profile attributes and sub-attributes for the given NSX-T manager.
 ...
 * @param optional nil or *NetworkContextProfileAttributesApiGetNetworkContextProfileAttributesOpts - Optional Parameters:
...
func (a *NetworkContextProfileAttributesApiService) GetNetworkContextProfileAttributes(ctx context.Context, localVarOptionals *NetworkContextProfileAttributesApiGetNetworkContextProfileAttributesOpts) (NetworkContextProfileAttributes, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NetworkContextProfileAttributes
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkContextProfiles/attributes"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v NetworkContextProfileAttributes
