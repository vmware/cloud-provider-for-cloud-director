...
func (a *NetworkContextProfilesApiService) CreateNetworkContextProfile(ctx context.Context, networkContextProfile NetworkContextProfile) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkContextProfiles"
	...
	// body params
	localVarPostBody = &networkContextProfile
	if ctx != nil {
...
/*
NetworkContextProfilesApiService Get all network context profiles.
 ...
 * @param optional nil or *NetworkContextProfilesApiGetNetworkContextProfilesOpts - Optional Parameters:
...
func (a *NetworkContextProfilesApiService) GetNetworkContextProfiles(ctx context.Context, page int32, pageSize int32, localVarOptionals *NetworkContextProfilesApiGetNetworkContextProfilesOpts) (NetworkContextProfiles, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NetworkContextProfiles
	)
...
/*
NetworkContextProfilesApiService Sync the network context profiles from the network provider to VCD.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *NetworkContextProfilesApiSyncNetworkContextProfilesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
...
func (a *NetworkContextProfilesApiService) SyncNetworkContextProfiles(ctx context.Context, localVarOptionals *NetworkContextProfilesApiSyncNetworkContextProfilesOpts) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkContextProfiles/sync"
