...
func (a *NetworkPoolApiService) DeleteNetworkPool(ctx context.Context, networkPoolId string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkPools/{networkPoolId}"
	localVarPath = strings.Replace(localVarPath, "{"+"networkPoolId"+"}", fmt.Sprintf("%v", networkPoolId), -1)
...
func (a *NetworkPoolApiService) SyncNetworkPool(ctx context.Context, networkPoolId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkPools/{networkPoolId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"networkPoolId"+"}", fmt.Sprintf("%v", networkPoolId), -1)
