...
/*
NetworkPoolsApiService Create a new network pool.
...
func (a *NetworkPoolsApiService) CreateNetworkPool(ctx context.Context, networkPool NetworkPool) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkPools"
...
/*
NetworkPoolsApiService Get summary of all the Network Pools in the system.
 ...
 * @param optional nil or *NetworkPoolsApiGetNetworkPoolsSummaryOpts - Optional Parameters:
...
func (a *NetworkPoolsApiService) GetNetworkPoolsSummary(ctx context.Context, page int32, pageSize int32, localVarOptionals *NetworkPoolsApiGetNetworkPoolsSummaryOpts) (NetworkPoolsSummary, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NetworkPoolsSummary
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/networkPools/networkPoolSummaries"
