...
/*
NsxAlbResourcesApiService Get all NSX-ALB Clouds from an NSX-ALB Controller.
 ...
 * @param optional nil or *NsxAlbResourcesApiGetImportableCloudsOpts - Optional Parameters:
...
func (a *NsxAlbResourcesApiService) GetImportableClouds(ctx context.Context, page int32, pageSize int32, localVarOptionals *NsxAlbResourcesApiGetImportableCloudsOpts) (NsxAlbClouds, *http.Response, error) {
	var (
		...
		localVarReturnValue NsxAlbClouds
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/nsxAlbResources/importableClouds"
...
/*
NsxAlbResourcesApiService Get all importable Service Engine Groups from an NSX-ALB Cloud.
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param pageSize Results per page to fetch.
 * @param optional nil or *NsxAlbResourcesApiGetImportableServiceEngineGroupsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
...
func (a *NsxAlbResourcesApiService) GetImportableServiceEngineGroups(ctx context.Context, pageSize int32, localVarOptionals *NsxAlbResourcesApiGetImportableServiceEngineGroupsOpts) (NsxAlbServiceEngineGroups, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue NsxAlbServiceEngineGroups
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/nsxAlbResources/importableServiceEngineGroups"
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v NsxAlbServiceEngineGroups
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
