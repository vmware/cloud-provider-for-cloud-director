...
/*
OrgVdcStoragePolicyApiService Get a paged list of all organization VDC level storage policies in the system
 ...
 * @param optional nil or *OrgVdcStoragePolicyApiGetOrgVdcStoragePoliciesOpts - Optional Parameters:
...
func (a *OrgVdcStoragePolicyApiService) GetOrgVdcStoragePolicies(ctx context.Context, page int32, pageSize int32, localVarOptionals *OrgVdcStoragePolicyApiGetOrgVdcStoragePoliciesOpts) (OrgVdcStoragePolicies, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue OrgVdcStoragePolicies
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcStoragePolicies"
...
func (a *OrgVdcStoragePolicyApiService) GetOrgVdcStoragePolicy(ctx context.Context, orgVdcStoragePolicyUrn string) (OrgVdcStoragePolicy, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue OrgVdcStoragePolicy
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcStoragePolicies/{orgVdcStoragePolicyUrn}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcStoragePolicyUrn"+"}", fmt.Sprintf("%v", orgVdcStoragePolicyUrn), -1)
...
/*
OrgVdcStoragePolicyApiService Get a paged list of the supported entity types for the specified Organization VDC storage policy.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param orgVdcStoragePolicyUrn orgVdcStoragePolicyUrn
 * @param optional nil or *OrgVdcStoragePolicyApiGetOrgVdcStoragePolicySupportedEntityTypesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *OrgVdcStoragePolicyApiService) GetOrgVdcStoragePolicySupportedEntityTypes(ctx context.Context, page int32, pageSize int32, orgVdcStoragePolicyUrn string, localVarOptionals *OrgVdcStoragePolicyApiGetOrgVdcStoragePolicySupportedEntityTypesOpts) (StoragePolicySupportedEntityTypes, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/orgVdcStoragePolicies/{orgVdcStoragePolicyUrn}/supportedEntityTypes"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcStoragePolicyUrn"+"}", fmt.Sprintf("%v", orgVdcStoragePolicyUrn), -1)
