...
func (a *PreferencesApiService) GetPreference(ctx context.Context, classifier string) (Preference, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/preferences/{classifier}"
...
func (a *PreferencesApiService) GetPreferenceDefinition(ctx context.Context, preferenceDefinitionId string) (PreferenceDefinition, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PreferenceDefinition
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/definitions/preferences/{preferenceDefinitionId}"
	localVarPath = strings.Replace(localVarPath, "{"+"preferenceDefinitionId"+"}", fmt.Sprintf("%v", preferenceDefinitionId), -1)
...
/*
PreferencesApiService Get list of preference definitions.
Get list of preference definitions 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *PreferencesApiQueryPreferenceDefinitionsOpts - Optional Parameters:
...
func (a *PreferencesApiService) QueryPreferenceDefinitions(ctx context.Context, page int32, pageSize int32, localVarOptionals *PreferencesApiQueryPreferenceDefinitionsOpts) (PreferenceDefinitions, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PreferenceDefinitions
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/definitions/preferences"
...
/*
PreferencesApiService Query user preferences.
Query user preferences 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *PreferencesApiQueryPreferencesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
...
func (a *PreferencesApiService) QueryPreferences(ctx context.Context, localVarOptionals *PreferencesApiQueryPreferencesOpts) (Preferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/preferences"
...
func (a *PreferencesApiService) UpdatePreference(ctx context.Context, updatePreferenceParams Preference, classifier string) (Preference, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updatePreferenceParams
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
