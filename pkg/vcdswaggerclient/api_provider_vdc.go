...
/*
ProviderVdcApiService Get all provider VDCs.
 ...
 * @param optional nil or *ProviderVdcApiGetAllProviderVDCsOpts - Optional Parameters:
...
func (a *ProviderVdcApiService) GetAllProviderVDCs(ctx context.Context, page int32, pageSize int32, localVarOptionals *ProviderVdcApiGetAllProviderVDCsOpts) (ProviderVdcs, *http.Response, error) {
	var (
		...
		localVarReturnValue ProviderVdcs
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/providerVdcs"
...
/*
ProviderVdcApiService Browse valid root resource pools hierarchy to back a Provider VDC.
...
func (a *ProviderVdcApiService) GetChildResourcePools(ctx context.Context, pvdcUrn string, moref string, page int32, pageSize int32) (ResourcePools, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/providerVdcs/{pvdcUrn}/infra/resourcePools/browse/{moref}"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcUrn"+"}", fmt.Sprintf("%v", pvdcUrn), -1)
...
func (a *ProviderVdcApiService) GetRootResourcePools(ctx context.Context, pvdcUrn string, page int32, pageSize int32) (ResourcePools, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/providerVdcs/{pvdcUrn}/infra/resourcePools/browse/"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcUrn"+"}", fmt.Sprintf("%v", pvdcUrn), -1)
