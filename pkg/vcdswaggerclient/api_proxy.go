...
/*
ProxyApiService Creates a proxy.
Creates a proxy. 
...
func (a *ProxyApiService) CreateProxy(ctx context.Context, proxy Proxy) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxies"
...
/*
ProxyApiService Delete a specific proxy. Will not delete an enabled proxy unless force is specified.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id Proxy ID URN
 * @param optional nil or *ProxyApiDeleteProxyOpts - Optional Parameters:
...
func (a *ProxyApiService) DeleteProxy(ctx context.Context, id string, localVarOptionals *ProxyApiDeleteProxyOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxies/{id}"
...
/*
ProxyApiService Gets a paged list of proxies for a tenant.
...
/*
ProxyApiService Gets the tenant-specific .pac file listing proxies accessible to the tenant.
...
func (a *ProxyApiService) GetProxiesPacFileForTenant(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxiesPac/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *ProxyApiService) GetProxyCRL(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxies/{id}/crl"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *ProxyApiService) GetProxyCertificate(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxies/{id}/cert"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
func (a *ProxyApiService) GetProxyCertificateThumbprint(ctx context.Context, id string) (ThumbprintAndAlgorithm, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ThumbprintAndAlgorithm
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxies/{id}/thumbprint"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
