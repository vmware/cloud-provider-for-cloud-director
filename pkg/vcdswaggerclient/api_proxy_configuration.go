...
/*
ProxyConfigurationApiService Creates a proxy configuration.
...
func (a *ProxyConfigurationApiService) CreateProxyConfiguration(ctx context.Context, proxyConfiguration ProxyConfiguration) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxyConfigurations"
	...
	// body params
	localVarPostBody = &proxyConfiguration
	if ctx != nil {
...
func (a *ProxyConfigurationApiService) DeleteProxyConfiguration(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/proxyConfigurations/{id}"
...
*/
func (a *ProxyConfigurationApiService) GetProxyConfiguration(ctx context.Context, id string) (ProxyConfiguration, *http.Response, error) {
	var (
...
/*
ProxyConfigurationApiService Gets a paged list of proxy configurations.
Gets a paged list of proxy configurations. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *ProxyConfigurationApiQueryProxyConfigurationsOpts - Optional Parameters:
...
func (a *ProxyConfigurationApiService) UpdateProxyConfiguration(ctx context.Context, updatedProxyConfiguration ProxyConfiguration, id string) (ProxyConfiguration, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updatedProxyConfiguration
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
