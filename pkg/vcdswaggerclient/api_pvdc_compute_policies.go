...
/*
PvdcComputePoliciesApiService Creates a new provider vDC compute policy
...
func (a *PvdcComputePoliciesApiService) CreatePvdcComputePolicy(ctx context.Context, pvdcComputePolicy PvdcComputePolicy) (PvdcComputePolicy, *http.Response, error) {
	var (
		...
		localVarReturnValue PvdcComputePolicy
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/pvdcComputePolicies"
...
func (a *PvdcComputePoliciesApiService) DeletePvdcComputePolicy(ctx context.Context, pvdcComputePolicyId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/pvdcComputePolicies/{pvdcComputePolicyId}"
...
/*
PvdcComputePoliciesApiService Get all VMs associated with this pVDC compute policy
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param pvdcComputePolicyId ID of provider VDC Compute Policy
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *PvdcComputePoliciesApiGetPvdcComputePolicyVmsOpts - Optional Parameters:
...
func (a *PvdcComputePoliciesApiService) GetPvdcComputePolicyVms(ctx context.Context, pvdcComputePolicyId string, page int32, pageSize int32, localVarOptionals *PvdcComputePoliciesApiGetPvdcComputePolicyVmsOpts) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/pvdcComputePolicies/{pvdcComputePolicyId}/vms"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcComputePolicyId"+"}", fmt.Sprintf("%v", pvdcComputePolicyId), -1)
...
/*
PvdcComputePoliciesApiService Get list of provider vDC compute policies.
Get list of provider vDC compute policies. Only filtering by pvdc compute policy name is supported. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *PvdcComputePoliciesApiQueryPvdcComputePoliciesOpts - Optional Parameters:
...
func (a *PvdcComputePoliciesApiService) QueryPvdcComputePolicies(ctx context.Context, page int32, pageSize int32, localVarOptionals *PvdcComputePoliciesApiQueryPvdcComputePoliciesOpts) (PvdcComputePolicies, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PvdcComputePolicies
	)
