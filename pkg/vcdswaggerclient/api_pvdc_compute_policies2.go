...
/*
PvdcComputePolicies2ApiService Creates a new provider vDC compute policy
...
func (a *PvdcComputePolicies2ApiService) CreatePvdcComputePolicy(ctx context.Context, pvdcComputePolicy PvdcComputePolicy2) (PvdcComputePolicy2, *http.Response, error) {
	var (
		...
		localVarReturnValue PvdcComputePolicy2
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/2.0.0/pvdcComputePolicies"
	...
	// body params
	localVarPostBody = &pvdcComputePolicy
	if ctx != nil {
...
func (a *PvdcComputePolicies2ApiService) DeletePvdcComputePolicy(ctx context.Context, pvdcComputePolicyId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/2.0.0/pvdcComputePolicies/{pvdcComputePolicyId}"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcComputePolicyId"+"}", fmt.Sprintf("%v", pvdcComputePolicyId), -1)
...
/*
PvdcComputePolicies2ApiService Get list of provider vDC compute policies.
 ...
 * @param optional nil or *PvdcComputePolicies2ApiQueryPvdcComputePoliciesOpts - Optional Parameters:
...
func (a *PvdcComputePolicies2ApiService) QueryPvdcComputePolicies(ctx context.Context, page int32, pageSize int32, localVarOptionals *PvdcComputePolicies2ApiQueryPvdcComputePoliciesOpts) (PvdcComputePolicies2, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PvdcComputePolicies2
	)
...
/*
PvdcComputePolicies2ApiService Get a list of Virtual Machine Classes associated with this policy.
 ...
 * @param optional nil or *PvdcComputePolicies2ApiQueryVirtualMachineClassesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *PvdcComputePolicies2ApiService) QueryVirtualMachineClasses(ctx context.Context, page int32, pageSize int32, pvdcComputePolicyId string, localVarOptionals *PvdcComputePolicies2ApiQueryVirtualMachineClassesOpts) (VirtualMachineClasses, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/2.0.0/pvdcComputePolicies/{pvdcComputePolicyId}/virtualMachineClasses"
	localVarPath = strings.Replace(localVarPath, "{"+"pvdcComputePolicyId"+"}", fmt.Sprintf("%v", pvdcComputePolicyId), -1)
