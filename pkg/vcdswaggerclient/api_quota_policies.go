...
/*
QuotaPoliciesApiService Creates a new quota policy
...
func (a *QuotaPoliciesApiService) CreateQuotaPolicy(ctx context.Context, quotaPolicyParams QuotaPolicy) (QuotaPolicy, *http.Response, error) {
	var (
		...
		localVarReturnValue QuotaPolicy
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/quotaPolicies"
	...
	// body params
	localVarPostBody = &quotaPolicyParams
	if ctx != nil {
...
func (a *QuotaPoliciesApiService) DeleteQuotaPolicy(ctx context.Context, quotaPolicyId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/quotaPolicies/{quotaPolicyId}"
	localVarPath = strings.Replace(localVarPath, "{"+"quotaPolicyId"+"}", fmt.Sprintf("%v", quotaPolicyId), -1)
...
/*
QuotaPoliciesApiService Get list of quota policies.
 ...
 * @param optional nil or *QuotaPoliciesApiQueryQuotaPoliciesOpts - Optional Parameters:
...
func (a *QuotaPoliciesApiService) QueryQuotaPolicies(ctx context.Context, page int32, pageSize int32, localVarOptionals *QuotaPoliciesApiQueryQuotaPoliciesOpts) (QuotaPolicies, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue QuotaPolicies
	)
...
func (a *QuotaPoliciesApiService) UpdateQuotaPolicy(ctx context.Context, updateQuotaPolicyParams QuotaPolicy, quotaPolicyId string) (QuotaPolicy, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updateQuotaPolicyParams
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
