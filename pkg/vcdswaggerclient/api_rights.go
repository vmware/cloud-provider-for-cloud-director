...
/*
RightsApiService Retrieve an individual right.
...
func (a *RightsApiService) GetRight(ctx context.Context, id string) (Right, *http.Response, error) {
	var (
		...
		localVarReturnValue Right
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/rights/{id}"
...
/*
RightsApiService Get list of rights visible to logged-in user
Get list of rights 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *RightsApiQueryRightsOpts - Optional Parameters:
...
func (a *RightsApiService) QueryRights(ctx context.Context, page int32, pageSize int32, localVarOptionals *RightsApiQueryRightsOpts) (Rights, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue Rights
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/rights"
