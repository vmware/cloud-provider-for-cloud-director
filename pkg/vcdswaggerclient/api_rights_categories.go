...
/*
RightsCategoriesApiService Retrieve an individual Right category.
...
*/
func (a *RightsCategoriesApiService) GetRightsCategory(ctx context.Context, id string) (RightsCategoryNode, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RightsCategoryNode
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/rightsCategories/{id}"
...
/*
RightsCategoriesApiService Get a list of Rights Categories visible to the logged in user
Get list of Rights Categories 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *RightsCategoriesApiQueryRightsCategoriesOpts - Optional Parameters:
...
func (a *RightsCategoriesApiService) QueryRightsCategories(ctx context.Context, page int32, pageSize int32, localVarOptionals *RightsCategoriesApiQueryRightsCategoriesOpts) (RightsCategoryNodes, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue RightsCategoryNodes
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/rightsCategories"
