...
/*
RolesApiService Adds the specified rights to a role.
...
func (a *RolesApiService) AddRightsToRole(ctx context.Context, rightsReferencesBody EntityReferences, id string) (EntityReferences, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/roles/{id}/rights"
...
/*
RolesApiService Creates a new role
Creates a new role 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param newRole
...
func (a *RolesApiService) CreateRole(ctx context.Context, newRole Role) (Role, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/roles"
...
func (a *RolesApiService) DeleteRole(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/roles/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
RolesApiService Gets a paged list of rights (as references) contained by a particular role
 ...
 * @param id
 * @param optional nil or *RolesApiQueryRoleRightsOpts - Optional Parameters:
...
/*
RolesApiService Get list of roles for a tenant
Get list of roles for a tenant 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *RolesApiQueryTenantRolesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
/*
RolesApiService Replaces the existing set of rights in role with the rights (as references) supplied.
