...
/*
SddcProxyApiService Creates an SDDC proxy.
...
func (a *SddcProxyApiService) CreateSddcProxy(ctx context.Context, proxy SddcProxy) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxies"
...
/*
SddcProxyApiService Delete a specific SDDC proxy. Will not delete an enabled proxy unless force is specified.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param id SDDC Proxy ID URN
 * @param optional nil or *SddcProxyApiDeleteSddcProxyOpts - Optional Parameters:
     * @param "Force" (optional.Bool) -  If true, will delete proxy regardless of proxy state.
...
func (a *SddcProxyApiService) DeleteSddcProxy(ctx context.Context, id string, localVarOptionals *SddcProxyApiDeleteSddcProxyOpts) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxies/{id}"
...
/*
SddcProxyApiService Gets a paged list of SDDC proxies for a tenant.
 ...
 * @param optional nil or *SddcProxyApiGetSddcProxiesOpts - Optional Parameters:
...
func (a *SddcProxyApiService) GetSddcProxies(ctx context.Context, page int32, pageSize int32, localVarOptionals *SddcProxyApiGetSddcProxiesOpts) (SddcProxies, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SddcProxies
	)
...
/*
SddcProxyApiService Gets the .pac file for the user&#39;s accessible proxies.
...
func (a *SddcProxyApiService) GetSddcProxiesPacFile(ctx context.Context) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxiesPac"
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-ns-proxy-autoconfig;version=36.0"}
...
func (a *SddcProxyApiService) GetSddcProxyCRL(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxies/{id}/crl"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-pkcs7-crl;version=36.0"}
...
func (a *SddcProxyApiService) GetSddcProxyCertificate(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxies/{id}/cert"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"application/x-x509-ca-cert;version=36.0", "application/x-pem-file;version=36.0"}
...
func (a *SddcProxyApiService) GetSddcProxyCertificateThumbprint(ctx context.Context, id string) (string, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/sddcProxies/{id}/thumbprint"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
	...
	// to determine the Accept header
	localVarHttpHeaderAccepts := []string{"text/plain;version=36.0"}
...
func (a *SddcProxyApiService) UpdateSddcProxy(ctx context.Context, updatedSddcProxy SddcProxy, id string) (SddcProxy, *http.Response, error) {
	...
	// body params
	localVarPostBody = &updatedSddcProxy
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
func (a *SddcProxyApiService) UpdateSddcProxyCRL(ctx context.Context, proxyCRL string, id string) (string, *http.Response, error) {
	...
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/x-pkcs7-crl"}
...
func (a *SddcProxyApiService) UpdateSddcProxyCertificate(ctx context.Context, proxyTrustAnchor string, id string) (string, *http.Response, error) {
	...
	// to determine the Content-Type header
	localVarHttpContentTypes := []string{"application/x-x509-ca-cert", "application/x-pem-file"}
	...
	// body params
	localVarPostBody = &proxyTrustAnchor
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
