...
/*
SecurityTagsApiService Retrieves the list of entities that have at least one tag assigned to it.
 ...
 * @param optional nil or *SecurityTagsApiGetSecurityTaggedEntitiesOpts - Optional Parameters:
...
func (a *SecurityTagsApiService) GetSecurityTaggedEntities(ctx context.Context, page int32, pageSize int32, localVarOptionals *SecurityTagsApiGetSecurityTaggedEntitiesOpts) (SecurityTaggedEntities, *http.Response, error) {
	var (
		...
		localVarReturnValue SecurityTaggedEntities
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/securityTags/entities"
...
/*
SecurityTagsApiService Retrieves the list of security tags that are in the organization.
 ...
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *SecurityTagsApiGetTagValuesOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *SecurityTagsApiService) GetTagValues(ctx context.Context, page int32, pageSize int32, localVarOptionals *SecurityTagsApiGetTagValuesOpts) (SecurityTagValues, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SecurityTagValues
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/securityTags/values"
...
/*
SecurityTagsApiService Retrieves the list of tags for a specific VM.
...
*/
func (a *SecurityTagsApiService) GetVmTags(ctx context.Context, id string) (EntitySecurityTags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue EntitySecurityTags
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/securityTags/vm/{id}"
...
/*
SecurityTagsApiService Updates a specific tag
...
func (a *SecurityTagsApiService) UpdateSecurityTag(ctx context.Context, securityTag SecurityTag) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/securityTags/tag"
...
/*
SecurityTagsApiService Update the list of tags for a specific VM.
...
@return EntitySecurityTags
*/
func (a *SecurityTagsApiService) UpdateVmTags(ctx context.Context, entityTags EntitySecurityTags, id string) (EntitySecurityTags, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Put")
		localVarPostBody   interface{}
		localVarFileName   string
