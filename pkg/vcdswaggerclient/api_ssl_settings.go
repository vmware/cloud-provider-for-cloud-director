...
/*
SslSettingsApiService Get the SSL settings
...
func (a *SslSettingsApiService) GetSslSettings(ctx context.Context) (SslSettings, *http.Response, error) {
	var (
		...
		localVarReturnValue SslSettings
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/ssl/settings"
...
/*
SslSettingsApiService Updates the SSL settings.
...
func (a *SslSettingsApiService) UpdateSslSettings(ctx context.Context, modifiedSslSettings SslSettings) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &modifiedSslSettings
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
