...
/*
StoragePolicyApiService Get a paged list of all Provider Storage Policies in the system
 ...
 * @param optional nil or *StoragePolicyApiGetStoragePoliciesOpts - Optional Parameters:
...
func (a *StoragePolicyApiService) GetStoragePolicies(ctx context.Context, page int32, pageSize int32, localVarOptionals *StoragePolicyApiGetStoragePoliciesOpts) (StoragePolicies, *http.Response, error) {
	var (
		...
		localVarReturnValue StoragePolicies
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/storagePolicies"
...
func (a *StoragePolicyApiService) GetStoragePolicy(ctx context.Context, storagePolicyUrn string) (StoragePolicy, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue StoragePolicy
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/storagePolicies/{storagePolicyUrn}"
	localVarPath = strings.Replace(localVarPath, "{"+"storagePolicyUrn"+"}", fmt.Sprintf("%v", storagePolicyUrn), -1)
