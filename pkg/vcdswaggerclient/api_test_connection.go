...
/*
TestConnectionApiService Test a connection
...
@return TestResult
*/
func (a *TestConnectionApiService) Test(ctx context.Context, connection Connection) (TestResult, *http.Response, error) {
	var (
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/testConnection"
