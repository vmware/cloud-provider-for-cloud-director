...
/*
TokenApiService Creates a new token of the specified type
 ...
 * @param optional nil or *TokenApiCreateTokenOpts - Optional Parameters:
     * @param "TokenParameters" (optional.Interface of TokenParameters) - 
...
func (a *TokenApiService) CreateToken(ctx context.Context, localVarOptionals *TokenApiCreateTokenOpts) (Token, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tokens"
	...
	// body params
	if localVarOptionals != nil && localVarOptionals.TokenParameters.IsSet() {
		
		localVarOptionalTokenParameters, localVarOptionalTokenParametersok := localVarOptionals.TokenParameters.Value().(TokenParameters)
		if !localVarOptionalTokenParametersok {
				return localVarReturnValue, nil, reportError("tokenParameters should be TokenParameters")
		}
		localVarPostBody = &localVarOptionalTokenParameters
	}
	if ctx != nil {
...
func (a *TokenApiService) DeleteToken(ctx context.Context, id string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/tokens/{id}"
...
/*
TokenApiService Retrieve tokens
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *TokenApiGetTokensOpts - Optional Parameters:
