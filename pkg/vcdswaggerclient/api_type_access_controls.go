...
/*
TypeAccessControlsApiService Creates an access-control grant for an entity type
...
func (a *TypeAccessControlsApiService) CreateEntityTypeAccessControlGrant(ctx context.Context, objectId string, accessControlGrant AccessControlGrant) (AccessControlGrant, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/entityTypes/{objectId}/accessControls"
...
/*
TypeAccessControlsApiService Get the specified access-control grant.
...
func (a *TypeAccessControlsApiService) GetEntityTypeAccessControlGrant(ctx context.Context, objectId string, accessControlId string) (AccessControlGrant, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/entityTypes/{objectId}/accessControls/{accessControlId}"
	localVarPath = strings.Replace(localVarPath, "{"+"objectId"+"}", fmt.Sprintf("%v", objectId), -1)
...
/*
TypeAccessControlsApiService Get the access-control list for the specified vCD entity type.
...
/*
TypeAccessControlsApiService Removes the specified access-control grant from the vCD entity type access-control list.
...
/*
TypeAccessControlsApiService Updates the specified access-control grant.
