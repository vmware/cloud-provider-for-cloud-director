...
/*
UiPluginApiService Delete system level logo
...
func (a *UiPluginApiService) DeleteUiPlugin(ctx context.Context, id string) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}"
...
/*
UiPluginApiService Retrieves a map of extension Points and an ordered list of items registered with that extension point
...
func (a *UiPluginApiService) GetExtensionPointSummary(ctx context.Context) (ExtensionPointSummary, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue ExtensionPointSummary
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/extensionPoints"
...
/*
UiPluginApiService Retrieves extension specific plugin metadata
...
*/
func (a *UiPluginApiService) GetUiPlugin(ctx context.Context, id string) (UiPluginMetadataResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UiPluginMetadataResponse
	)
	...
	if localVarHttpResponse.StatusCode >= 300 {
		...
		if localVarHttpResponse.StatusCode == 200 {
			var v UiPluginMetadataResponse
			err = a.client.decode(&v, localVarBody, localVarHttpResponse.Header.Get("Content-Type"));
				if err != nil {
					newErr.error = err.Error()
					return localVarReturnValue, localVarHttpResponse, newErr
...
/*
UiPluginApiService Customizes the order and enables/disables extension Points
...
func (a *UiPluginApiService) PutExtensionPointSummary(ctx context.Context, extensionPointSummaryBody ExtensionPointSummary) (ExtensionPointSummary, *http.Response, error) {
	...
	// body params
	localVarPostBody = &extensionPointSummaryBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
...
/*
UiPluginApiService Updates extension specific plugin&#39;s metadata
...
func (a *UiPluginApiService) PutUiPlugin(ctx context.Context, pluginMetadataBody UiPluginMetadata, id string) (UiPluginMetadataResponse, *http.Response, error) {
	...
	// body params
	localVarPostBody = &pluginMetadataBody
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
