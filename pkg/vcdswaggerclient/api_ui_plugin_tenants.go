...
/*
UiPluginTenantsApiService Retrieves list of tenants for whom the plugin is explicitly published
 ...
 * @param optional nil or *UiPluginTenantsApiGetUiPluginTenantsOpts - Optional Parameters:
...
func (a *UiPluginTenantsApiService) GetUiPluginTenants(ctx context.Context, id string, page int32, pageSize int32, localVarOptionals *UiPluginTenantsApiGetUiPluginTenantsOpts) (EntityReferences, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}/tenants"
...
/*
UiPluginTenantsApiService Publishes the UI plugin to the specified tenants
...
func (a *UiPluginTenantsApiService) PostUiPluginPublish(ctx context.Context, publishTenantsBody []EntityReference, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}/tenants/publish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UiPluginTenantsApiService Publishes the UI plugin to all tenants
...
func (a *UiPluginTenantsApiService) PostUiPluginPublishAll(ctx context.Context, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}/tenants/publishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UiPluginTenantsApiService Revokes publication of the UI plugin to the specified tenants
...
func (a *UiPluginTenantsApiService) PostUiPluginUnpublish(ctx context.Context, unpublishTenantsBody []EntityReference, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}/tenants/unpublish"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
...
/*
UiPluginTenantsApiService Unpublishes the UI plugin from all tenants
...
func (a *UiPluginTenantsApiService) PostUiPluginUnpublishAll(ctx context.Context, id string) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/extensions/ui/{id}/tenants/unpublishAll"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", fmt.Sprintf("%v", id), -1)
