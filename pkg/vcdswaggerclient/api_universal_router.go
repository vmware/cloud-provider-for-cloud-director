...
/*
UniversalRouterApiService Deletes a specific Universal Router
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param universalRouterId
 * @param optional nil or *UniversalRouterApiDeleteUniversalRouterOpts - Optional Parameters:
...
func (a *UniversalRouterApiService) DeleteUniversalRouter(ctx context.Context, universalRouterId string, localVarOptionals *UniversalRouterApiDeleteUniversalRouterOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}"
...
func (a *UniversalRouterApiService) GetUniversalRouter(ctx context.Context, universalRouterId string) (UniversalRouter, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UniversalRouter
	)
...
/*
UniversalRouterApiService Sync/repair the Universal Router
...
func (a *UniversalRouterApiService) SyncUniversalRouter(ctx context.Context, universalRouterId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
