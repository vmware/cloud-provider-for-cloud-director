...
/*
UniversalRouterHealthApiService Get Health information of a universal router
...
func (a *UniversalRouterHealthApiService) GetUniversalRouterHealth(ctx context.Context, universalRouterId string) (RouterHealthReport, *http.Response, error) {
	var (
		...
		localVarReturnValue RouterHealthReport
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/health"
