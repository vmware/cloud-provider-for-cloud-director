...
/*
UniversalRoutersApiService Create a new universal router
...
func (a *UniversalRoutersApiService) CreateUniversalRouter(ctx context.Context, universalRouter UniversalRouter) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters"
	...
	// body params
	localVarPostBody = &universalRouter
	if ctx != nil {
...
/*
UniversalRoutersApiService Get all the universal routers defined for a vDC group
...
func (a *UniversalRoutersApiService) GetAllUniversalRoutersForVdcGroup(ctx context.Context, vdcGroupId string) (UniversalRouters, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UniversalRouters
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/{vdcGroupId}/universalRouters"
