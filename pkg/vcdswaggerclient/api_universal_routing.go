...
func (a *UniversalRoutingApiService) GetUniversalEgressRouting(ctx context.Context, universalRouterId string) (UniversalEgressRoutes, *http.Response, error) {
	var (
		...
		localVarReturnValue UniversalEgressRoutes
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/routing"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
...
func (a *UniversalRoutingApiService) GetUniversalRoutes(ctx context.Context, universalRouterId string) (UniversalRoutes, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue UniversalRoutes
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/routing/routes"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
...
/*
UniversalRoutingApiService Sync/repair the routing configuration for a Universal Router.
...
func (a *UniversalRoutingApiService) SyncUniversalRoutes(ctx context.Context, universalRouterId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/universalRouters/{universalRouterId}/routing/routes/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"universalRouterId"+"}", fmt.Sprintf("%v", universalRouterId), -1)
...
func (a *UniversalRoutingApiService) UpdateUniversalEgressRouting(ctx context.Context, universalEgressRoutes UniversalEgressRoutes, universalRouterId string) (*http.Response, error) {
	...
	// body params
	localVarPostBody = &universalEgressRoutes
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
