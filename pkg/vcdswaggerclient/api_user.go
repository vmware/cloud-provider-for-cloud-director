...
func (a *UserApiService) CreateUser(ctx context.Context, newUser VcdUser) (VcdUser, *http.Response, error) {
	var (
		...
		localVarReturnValue VcdUser
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/users"
...
func (a *UserApiService) DeleteUser(ctx context.Context, userUrn string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/users/{userUrn}"
	localVarPath = strings.Replace(localVarPath, "{"+"userUrn"+"}", fmt.Sprintf("%v", userUrn), -1)
...
/*
UserApiService Get a specified user by id.
...
/*
UserApiService Get a list of groups that the user with the given id belongs to.
 ...
 * @param userUrn userUrn
 * @param optional nil or *UserApiQueryUserGroupsOpts - Optional Parameters:
...
func (a *UserApiService) QueryUserGroups(ctx context.Context, page int32, pageSize int32, userUrn string, localVarOptionals *UserApiQueryUserGroupsOpts) (EntityReferences, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/users/{userUrn}/groups"
	localVarPath = strings.Replace(localVarPath, "{"+"userUrn"+"}", fmt.Sprintf("%v", userUrn), -1)
...
/*
UserApiService Get a list of users.
Get a list of users. 
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *UserApiQueryUsersOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
/*
UserApiService Modify the details of a user. A non-administrator user may only modify their own password. An administrator can edit any user.
