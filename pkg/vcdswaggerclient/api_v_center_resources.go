...
/*
VCenterResourcesApiService Retrieves all distributed virtual switches.
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *VCenterResourcesApiGetDvSwitchesOpts - Optional Parameters:
...
func (a *VCenterResourcesApiService) GetDvSwitches(ctx context.Context, page int32, pageSize int32, localVarOptionals *VCenterResourcesApiGetDvSwitchesOpts) (DvSwitches, *http.Response, error) {
	var (
		...
		localVarReturnValue DvSwitches
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/virtualCenters/resources/dvSwitches"
...
/*
VCenterResourcesApiService Get all DVPG network backings that are available.
 ...
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *VCenterResourcesApiGetImportableDvpgsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *VCenterResourcesApiService) GetImportableDvpgs(ctx context.Context, page int32, pageSize int32, localVarOptionals *VCenterResourcesApiGetImportableDvpgsOpts) (DistributedPortGroups, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue DistributedPortGroups
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/virtualCenters/resources/importableDvpgs"
...
/*
VCenterResourcesApiService Get all standard porgroups available as backings.
 ...
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *VCenterResourcesApiGetImportablePortgroupsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *VCenterResourcesApiService) GetImportablePortgroups(ctx context.Context, page int32, pageSize int32, localVarOptionals *VCenterResourcesApiGetImportablePortgroupsOpts) (PortGroups, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue PortGroups
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/virtualCenters/resources/importablePortgroups"
