...
func (a *VRealizeOrchestratorsApiService) DiscoverVroVcenter(ctx context.Context, body VroServiceInfo) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/vro/servers/discovery"
...
*/
func (a *VRealizeOrchestratorsApiService) GetRegisteredVROs(ctx context.Context) ([]VroServiceInfo, *http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vro/servers"
...
@return VroServiceInfo
*/
func (a *VRealizeOrchestratorsApiService) Register(ctx context.Context, body VroServiceInfo) (VroServiceInfo, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
