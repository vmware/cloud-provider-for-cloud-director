...
/*
VdcApiService Retrieves all compute policies of a vDC
 ...
 * @param orgVdcId
 * @param optional nil or *VdcApiGetComputePoliciesOpts - Optional Parameters:
...
func (a *VdcApiService) GetComputePolicies(ctx context.Context, page int32, pageSize int32, orgVdcId string, localVarOptionals *VdcApiGetComputePoliciesOpts) (VdcComputePolicies, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcs/{orgVdcId}/computePolicies"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcId"+"}", fmt.Sprintf("%v", orgVdcId), -1)
...
func (a *VdcApiService) GetVdc(ctx context.Context, orgVdcId string) (OrgVdc, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue OrgVdc
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcs/{orgVdcId}"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcId"+"}", fmt.Sprintf("%v", orgVdcId), -1)
...
/*
VdcApiService Retrieves Max Compute Policy of the vDC.
...
func (a *VdcApiService) GetVdcMaxComputePolicy(ctx context.Context, orgVdcId string) (VdcComputePolicy, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcs/{orgVdcId}/maxComputePolicy"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcId"+"}", fmt.Sprintf("%v", orgVdcId), -1)
...
/*
VdcApiService Retrieves a list of vDCs
 ...
 * @param page Page to fetch, zero offset.
 * @param pageSize Results per page to fetch.
 * @param optional nil or *VdcApiQueryVdcsOpts - Optional Parameters:
     * @param "Filter" (optional.String) -  Filter for a query.  FIQL format.
     * @param "SortAsc" (optional.String) -  Field to use for ascending sort
     * @param "SortDesc" (optional.String) -  Field to use for descending sort
...
func (a *VdcApiService) QueryVdcs(ctx context.Context, page int32, pageSize int32, localVarOptionals *VdcApiQueryVdcsOpts) (OrgVdcs, *http.Response, error) {
	var (
		...
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue OrgVdcs
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcs"
...
/*
VdcApiService Updates Max Compute Policy of the vDC.
