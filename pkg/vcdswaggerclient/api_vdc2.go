...
/*
Vdc2ApiService Retrieves all compute policies of a vDC
 ...
 * @param orgVdcId
 * @param optional nil or *Vdc2ApiGetComputePoliciesOpts - Optional Parameters:
...
func (a *Vdc2ApiService) GetComputePolicies(ctx context.Context, page int32, pageSize int32, orgVdcId string, localVarOptionals *Vdc2ApiGetComputePoliciesOpts) (VdcComputePolicies2, *http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/2.0.0/vdcs/{orgVdcId}/computePolicies"
...
/*
Vdc2ApiService Retrieves Max Compute Policy of the vDC.
...
func (a *Vdc2ApiService) GetVdcMaxComputePolicy(ctx context.Context, orgVdcId string) (VdcComputePolicy2, *http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/2.0.0/vdcs/{orgVdcId}/maxComputePolicy"
	localVarPath = strings.Replace(localVarPath, "{"+"orgVdcId"+"}", fmt.Sprintf("%v", orgVdcId), -1)
...
/*
Vdc2ApiService Updates Max Compute Policy of the vDC.
...
func (a *Vdc2ApiService) UpdateVdcMaxComputePolicy(ctx context.Context, newVdcComputePolicy2Params VdcComputePolicy2, orgVdcId string) (VdcComputePolicy2, *http.Response, error) {
	...
	// body params
	localVarPostBody = &newVdcComputePolicy2Params
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
