...
/*
VdcGroupApiService Deletes a vDC Group
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param vdcGroupId
 * @param optional nil or *VdcGroupApiDeleteVdcGroupOpts - Optional Parameters:
...
func (a *VdcGroupApiService) DeleteVdcGroup(ctx context.Context, vdcGroupId string, localVarOptionals *VdcGroupApiDeleteVdcGroupOpts) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/{vdcGroupId}"
...
func (a *VdcGroupApiService) SyncVdcGroup(ctx context.Context, vdcGroupId string) (*http.Response, error) {
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/{vdcGroupId}/sync"
	localVarPath = strings.Replace(localVarPath, "{"+"vdcGroupId"+"}", fmt.Sprintf("%v", vdcGroupId), -1)
