...
func (a *VdcGroupsApiService) CreateVdcGroup(ctx context.Context, vdcGroup VdcGroup) (*http.Response, error) {
	...
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups"
...
/*
VdcGroupsApiService Get a list of vDC Groups.
 ...
 * @param optional nil or *VdcGroupsApiGetVdcGroupsOpts - Optional Parameters:
