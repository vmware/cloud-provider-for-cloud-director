...
*/
func (a *VdcGroupsSettingsApiService) GetVdcGroupSettings(ctx context.Context) (VdcGroupSettings, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue VdcGroupSettings
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/1.0.0/vdcGroups/settings"
...
func (a *VdcGroupsSettingsApiService) UpdateVdcGroupSettings(ctx context.Context, vdcGroupSettings VdcGroupSettings) (VdcGroupSettings, *http.Response, error) {
	...
	// body params
	localVarPostBody = &vdcGroupSettings
	if ctx != nil {
		// API Key Authentication
		if auth, ok := ctx.Value(ContextAPIKey).(APIKey); ok {
			var key string
