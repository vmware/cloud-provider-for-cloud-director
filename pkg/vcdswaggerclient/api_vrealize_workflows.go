...
/*
VrealizeWorkflowsApiService Browse remote vRealize Orchestrator workflows
 ...
 * @param optional nil or *VrealizeWorkflowsApiGetRemoteWorkflowsOpts - Optional Parameters:
...
func (a *VrealizeWorkflowsApiService) GetRemoteWorkflows(ctx context.Context, page int32, pageSize int32, vroServerId string, localVarOptionals *VrealizeWorkflowsApiGetRemoteWorkflowsOpts) (VroRemoteWorkflowItems, *http.Response, error) {
	var (
		...
		localVarReturnValue VroRemoteWorkflowItems
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/vro/servers/{vroServerId}/workflows"
	localVarPath = strings.Replace(localVarPath, "{"+"vroServerId"+"}", fmt.Sprintf("%v", vroServerId), -1)
