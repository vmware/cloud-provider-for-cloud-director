...
// A list of Branding Themes and organizations for which they are set as active. 
type BrandingThemesAssignments struct {
	...
	// The current page of branding themes.
	Values []BrandingThemeAssignment `json:"values"`
}
