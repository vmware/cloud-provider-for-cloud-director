...
type EdgeLoadBalancerPool struct {
	...
	HealthMonitors []EdgeLoadBalancerHealthMonitor `json:"healthMonitors"`
	// Selected persistence profile for the Load Balancer Pool.
	PersistenceProfile *EdgeLoadBalancerPersistenceProfile `json:"persistenceProfile"`
	...
	Members []EdgeLoadBalancerPoolMember `json:"members"`
	...
	MemberGroupRef *EntityReference `json:"memberGroupRef"`
	...
	CaCertificateRefs []EntityReference `json:"caCertificateRefs"`
	...
	CommonNameCheckEnabled bool `json:"commonNameCheckEnabled"`
