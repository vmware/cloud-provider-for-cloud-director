...
type EdgeLoadBalancerPoolSummary struct {
	...
	PassiveMonitoringEnabled bool `json:"passiveMonitoringEnabled"`
	...
	EnabledMemberCount int32 `json:"enabledMemberCount"`
	// The number of enabled members in the pool that are operational.
	UpMemberCount int32 `json:"upMemberCount"`
	...
	ActiveMonitoringEnabled bool `json:"activeMonitoringEnabled"`
	...
	VirtualServiceRefs []EntityReference `json:"virtualServiceRefs"`
	// Whether SSL is enabled for communication between the Load Balancer Virtual Services and the pool members 
	MemberSslEnabled bool `json:"memberSslEnabled"`
	// The type of Edge Firewall Group representing destination servers which are used by the Load Balancer Pool to direct load balanced traffic.  This value will be absent if the pool is using an IP Address-based pool member specification instead of an Edge Firewall Group.  Valid values include: <ul>   <li><code> IP_SET </code>   <li><code> STATIC_MEMBERS </code>   <li><code> VM_CRITERIA </code> </ul> 
	MemberGroupType string `json:"memberGroupType"`
}
