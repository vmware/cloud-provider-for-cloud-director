...
type SslSettings struct {
	// SSL protocols
	EnabledSslProtocols []string `json:"enabledSslProtocols"`
	// SSL ciphers
	EnabledSslCiphers []string `json:"enabledSslCiphers"`
	...
	EcKeySize int32 `json:"ecKeySize"`
	// Number of days any VCD generated certificate will be valid for
	CertificateValidityDays int32 `json:"certificateValidityDays"`
