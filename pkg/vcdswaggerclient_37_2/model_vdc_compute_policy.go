...
type VdcComputePolicy struct {
	...
	MemoryReservationGuarantee float64 `json:"memoryReservationGuarantee"`
	// The factor of the configured CPU reserved for the VM on which this policy is applied. 
	CpuReservationGuarantee float64 `json:"cpuReservationGuarantee"`
	...
	IsSizingOnly bool `json:"isSizingOnly"`
